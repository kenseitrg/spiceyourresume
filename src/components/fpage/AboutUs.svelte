<div class="container col-xxl-10 px-4 py-5 text-center bg-light my-img">
	<div class="col-md-10 p-lg-5 mx-auto my-5">
		...
		<p class="lead fw-normal">
			Since our founding, we’ve worked with numerous clients throughout the area. Great service
			begins and ends with experienced and friendly professionals, which is why we put so much
			consideration into selecting only the best to join our team. We complete projects efficiently
			and on schedule, and go above and beyond to form lasting relationships with our clients.
		</p>
		<hr class="my-line" />
